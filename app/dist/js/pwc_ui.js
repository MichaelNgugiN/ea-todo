...
function transition(element, props, duration, transition) {
    ...
    return promise(function (resolve, reject) {
        ...
        one(element, (transitionend + " " + transitioncancel), function (ref) {
            ...
            clearTimeout(timer);
            element.removeClass('pwc-transition').css('transition', '');
...
var Transition = {
    ...
    inProgress: function inProgress(element) {
        return $__default(element).hasClass('pwc-transition');
    }

};

var animationcancel = 'animationcancel';
var animationprefix = 'pwc-animation-';
var clsCancelAnimation = 'pwc-cancel-animation';
...
var boot = function (UIkit) {
    ...
    function apply(node, fn) {
        ...
        if (node.nodeType !== Node.ELEMENT_NODE || node.hasAttribute('pwc-no-boot')) {
            return;
        }
...
var componentAPI = function (UIkit) {
    ...
    UIkit.component = function (id, options) {
        ...
        if (UIkit._initialized && !options.options.functional) {
            fastdom.measure(function () { return UIkit[name](("[pwc-" + id + "],[data-pwc-" + id + "]")); });
        }
    ...
    UIkit.connect = function (node) {
        ...
        for (var i = 0; i < node.attributes.length; i++) {
            ...
            if (name.lastIndexOf('pwc-', 0) === 0 || name.lastIndexOf('data-pwc-', 0) === 0) {

                name = camelize(name.replace('data-pwc-', '').replace('pwc-', ''));
            ...
            return promise(function (resolve) {
                ...
                if (!this$1.queued || !isUndefined(animate) || !isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                    ...
                    var body = document.body,
                        ...
                        el = toggled[0],
                        inProgress = Animation.inProgress(el) && this$1.$hasClass(el, 'pwc-animation-leave')
        ...
        _toggleElement: function _toggleElement(el, show, animate) {
            ...
            show = isBoolean(show)
                ...
                : Animation.inProgress(el)
                    ? this.$hasClass(el, 'pwc-animation-leave')
...
var Accordion = function (UIkit) {
    ...
    UIkit.component('accordion', {
        ...
        defaults: {
            ...
            multiple: false,
            clsOpen: 'pwc-open',
            toggle: '> .pwc-accordion-title',
            content: '> .pwc-accordion-content',
            transition: 'ease'
        },
...
var Drop = function (UIkit) {
    ...
    UIkit.component('drop', {
        ...
        defaults: {
            ...
            clsDrop: false,
            hoverIdle: 200,
            animation: ['pwc-animation-fade'],
            cls: 'pwc-open'
        },

        init: function init() {
            this.tracker = new MouseTracker();
            this.clsDrop = this.clsDrop || ("pwc-" + (this.$options.name));
        ...
        events: [

            {
                ...
                handler: function handler(ref) {
                    ...
                    this.state.toggleClass(("pwc-" + (~type.indexOf('focus') ? 'focus' : 'hover')), ~['focusin', 'mouseenter'].indexOf(type));
                }
...
var Grid = function (UIkit) {
    ...
    UIkit.component('grid', UIkit.components.margin.extend({
        ...
        defaults: {
            margin: 'pwc-grid-margin',
            clsStack: 'pwc-grid-stack'
        },
...
var Hover = function (UIkit) {
    ...
    ready(function () {
        ...
        UIkit.hoverSelector = '.pwc-animation-toggle, .pwc-transition-toggle, [pwc-hover]';
...
var Icon = function (UIkit) {
    ...
    [
        ...
        init: function init() {
            this.$addClass('pwc-slidenav');

            if (this.$hasClass('pwc-slidenav-large')) {
                this.icon += '-large';
            }
        }
    ...
    registerComponent('search-icon', {
        ...
        init: function init() {
            if (this.$hasClass('pwc-search-icon') && this.$el.parents('.pwc-search-large').length) {
                this.icon = 'search-large';
            } else if (this.$el.parents('.pwc-search-navbar').length) {
    ...
    registerComponent('close', {
        ...
        init: function init() {
            this.icon = "close-" + (this.$hasClass('pwc-close-large') ? 'large' : 'icon');
        }
...
var Margin = function (UIkit) {
    ...
    UIkit.component('margin', {
        ...
        defaults: {
            margin: 'pwc-margin-small-top',
            firstColumn: 'pwc-first-column'
        },
...
var Modal$1 = function (UIkit) {
    ...
    UIkit.component('modal', {
        ...
        defaults: {
            clsPage: 'pwc-modal-page',
            clsPanel: 'pwc-modal-dialog',
            selClose: '.pwc-modal-close, .pwc-modal-close-default, .pwc-modal-close-outside, .pwc-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function handler() {
                    ...
                    if (this.panel.hasClass('pwc-margin-auto-vertical')) {
                        this.$el.addClass('pwc-flex');
                    } else {
...

            {
                ...
                handler: function handler() {
                    ...
                    this.$el.css('display', '').removeClass('pwc-flex');
    ...
    UIkit.component('overflow-auto', {
        ...
        computed: {
            ...
            modal: function modal() {
                return this.$el.closest('.pwc-modal');
            },

            panel: function panel() {
                return this.$el.closest('.pwc-modal-dialog');
            }
    ...
    UIkit.modal.dialog = function (content, options) {
        ...
        var dialog = UIkit.modal((" <div class=\"pwc-modal\"> <div class=\"pwc-modal-dialog\">" + content + "</div> </div> "), options);
    ...
    UIkit.modal.alert = function (message, options) {
        ...
        return promise(
            function (resolve) { return UIkit.modal.dialog((" <div class=\"pwc-modal-body\">" + (isString(message) ? message : $__default(message).html()) + "</div> <div class=\"pwc-modal-footer pwc-text-right\"> <button class=\"pwc-button pwc-button-primary pwc-modal-close\" autofocus>" + (options.labels.ok) + "</button> </div> "), options).$el.on('hide', resolve); }
        );
    };
    ...
    UIkit.modal.confirm = function (message, options) {
        ...
        return promise(
            function (resolve, reject) { return UIkit.modal.dialog((" <div class=\"pwc-modal-body\">" + (isString(message) ? message : $__default(message).html()) + "</div> <div class=\"pwc-modal-footer pwc-text-right\"> <button class=\"pwc-button pwc-button-default pwc-modal-close\">" + (options.labels.cancel) + "</button> <button class=\"pwc-button pwc-button-primary pwc-modal-close\" autofocus>" + (options.labels.ok) + "</button> </div> "), options).$el.on('click', '.pwc-modal-footer button', function (e) { return $__default(e.target).index() === 0 ? reject() : resolve(); }); }
        );
    };
    ...
    UIkit.modal.prompt = function (message, value, options) {
        ...
        return promise(function (resolve) {
            ...
            var resolved = false,
                prompt = UIkit.modal.dialog((" <form class=\"pwc-form-stacked\"> <div class=\"pwc-modal-body\"> <label>" + (isString(message) ? message : $__default(message).html()) + "</label> <input class=\"pwc-input\" type=\"text\" autofocus> </div> <div class=\"pwc-modal-footer pwc-text-right\"> <button class=\"pwc-button pwc-button-default pwc-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"pwc-button pwc-button-primary\" type=\"submit\">" + (options.labels.ok) + "</button> </div> </form> "), options),
...
var Navbar = function (UIkit) {
    ...
    UIkit.component('navbar', {
        ...
        defaults: {
            dropdown: '.pwc-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'pwc-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
    ...
    UIkit.component('navbar-dropbar', {
        ...
        init: function init() {
            ...
            if (this.mode === 'slide') {
                this.$addClass('pwc-navbar-dropbar-slide');
            }
...
var Offcanvas = function (UIkit) {
    ...
    UIkit.component('offcanvas', {
        ...
        defaults: {
            content: '.pwc-offcanvas-content:first',
            mode: 'slide',
            flip: false,
            overlay: false,
            clsPage: 'pwc-offcanvas-page',
            clsContainer: 'pwc-offcanvas-container',
            clsPanel: 'pwc-offcanvas-bar',
            clsFlip: 'pwc-offcanvas-flip',
            clsContent: 'pwc-offcanvas-content',
            clsContentAnimation: 'pwc-offcanvas-content-animation',
            clsSidebarAnimation: 'pwc-offcanvas-bar-animation',
            clsMode: 'pwc-offcanvas',
            clsOverlay: 'pwc-offcanvas-overlay',
            selClose: '.pwc-offcanvas-close'
        },
...
var Responsive = function (UIkit) {
    ...
    UIkit.component('responsive', {
        ...
        init: function init() {
            this.$addClass('pwc-responsive-width');
        },
...
var Scrollspy = function (UIkit) {
    ...
    UIkit.component('scrollspy', {
        ...
        defaults: {
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'pwc-scrollspy-inview'
        },
...

            {
                ...
                read: function read() {
                    ...
                    this.elements.each(function (_, el) {
                        ...
                        if (!el._scrollspy) {
                            var cls = $__default(el).attr('pwc-scrollspy-class');
...
var Sticky = function (UIkit) {
    ...
    UIkit.component('sticky', {
        ...
        defaults: {
            ...
            offset: 0,
            animation: '',
            clsActive: 'pwc-active',
            clsInactive: '',
            clsFixed: 'pwc-sticky-fixed',
            clsBelow: 'pwc-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            media: false,
        ...
        connected: function connected() {
            ...
            this.placeholder = $__default('<div class="pwc-sticky-placeholder"></div>');
...
var Switcher = function (UIkit) {
    ...
    UIkit.component('switcher', {
        ...
        defaults: {
            ...
            swiping: true,
            cls: 'pwc-active',
            clsContainer: 'pwc-switcher',
            attrItem: 'pwc-switcher-item',
            queued: true
        },
        ...
        events: [

            {
                ...
                delegate: function delegate() {
                    return ((this.toggle) + ":not(.pwc-disabled)");
                },
        ...
        methods: {
            ...
            show: function show(item) {
                ...
                for (var i = 0; i < length; i++, index = (index + dir + length) % length) {
                    if (!this$1.toggles.eq(index).is('.pwc-disabled, [disabled]')) {
...
var Tab = function (UIkit) {
    ...
    UIkit.component('tab', UIkit.components.switcher.extend({
        ...
        defaults: {
            media: 960,
            attrItem: 'pwc-tab-item'
        },

        init: function init() {

            var cls = this.$hasClass('pwc-tab-left') && 'pwc-tab-left' || this.$hasClass('pwc-tab-right') && 'pwc-tab-right';
...
var Leader = function (UIkit) {
    ...
    UIkit.component('leader', {
        ...
        defaults: {
            fill: '',
            media: false,
            clsWrapper: 'pwc-leader-fill',
            clsHide: 'pwc-leader-hide',
            attrFill: 'data-fill'
        },
...
var core = function (UIkit) {
    ...
    animationstart && on(document, animationstart, function (ref) {
        ...
        if ((getStyle(target, 'animationName') || '').match(/^pwc-.*(left|right)/)) {
            started++;
    ...
    UIkit.mixin.slideshow = {
        ...
        methods: {
            ...
            show: function show(index, force) {
                ...
                var hasPrev = this.slides.hasClass('pwc-active'),
                    dir = index === 'next'
                            ? 1
                            : index === 'previous'
                                ? -1
...
function plugin$1(UIkit) {
    ...
    UIkit.component('lightbox-panel', {
        ...
        defaults: {
            ...
            items: [],
            cls: 'pwc-open',
            clsPage: 'pwc-lightbox-page',
            clsItem: 'pwc-lightbox-item',
            attrItem: 'pwc-lightbox-item',
            template: " <div class=\"pwc-lightbox pwc-overflow-hidden\"> <ul class=\"pwc-lightbox-items\"></ul> <div class=\"pwc-lightbox-toolbar pwc-position-top pwc-text-right\"> <button class=\"pwc-lightbox-toolbar-icon pwc-close-large\" type=\"button\" pwc-close pwc-toggle=\"!.pwc-lightbox\"></button> </div> <a class=\"pwc-lightbox-button pwc-position-center-left pwc-position-medium\" href=\"#\" pwc-slidenav-previous pwc-lightbox-item=\"previous\"></a> <a class=\"pwc-lightbox-button pwc-position-center-right pwc-position-medium\" href=\"#\" pwc-slidenav-next pwc-lightbox-item=\"next\"></a> <div class=\"pwc-lightbox-toolbar pwc-lightbox-caption pwc-position-bottom pwc-text-center\"></div> </div>"
        },
        ...
        created: function created() {
            ...
            this.list = this.$el.find('.pwc-lightbox-items');
            this.toolbars = this.$el.find('.pwc-lightbox-toolbar');
            this.nav = this.$el.find('a[pwc-lightbox-item]');
            this.caption = this.$el.find('.pwc-lightbox-caption');
        ...
        events: [
...

            {
                ...
                handler: function handler() {
                    ...
                    this.$addClass(this.caption, 'pwc-animation-slide-bottom');
...

            {
                ...
                handler: function handler() {
                    ...
                    this.$removeClass(this.caption, 'pwc-animation-slide-bottom');
                    this.toolbars.attr('hidden', true);
                    this.nav.attr('hidden', true);
...

            {
                ...
                handler: function handler(_, item) {
                    ...
                    this.setItem(item, '<span pwc-spinner></span>');
                    ...
                    // Video
                        ...
                        var video = $$$1('<video controls playsinline pwc-video></video>')
                    ...
                    // Iframe
                        ...
                        this.setItem(item, ("<iframe class=\"pwc-lightbox-iframe\" src=\"" + source + "\" frameborder=\"0\" allowfullscreen></iframe>"));
        ...
        methods: {
            ...
            setError: function setError(item) {
                this.setItem(item, '<span pwc-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function showControls() {
                ...
                animate(this.toolbars.eq(0), 'pwc-animation-slide-top');
                animate(this.toolbars.eq(1), 'pwc-animation-slide-bottom');

                this.nav.attr('hidden', this.items.length <= 1);

                if (this.items.length > 1) {
                    animate(this.nav, 'pwc-animation-fade');
                }
            ...
            hideControls: function hideControls() {
                ...
                animate(this.toolbars.eq(0), 'pwc-animation-slide-top', 'out');
                animate(this.toolbars.eq(1), 'pwc-animation-slide-bottom', 'out');

                if (this.items.length > 1) {
                    animate(this.nav, 'pwc-animation-fade', 'out');
                }
    ...
    function getIframe(src, width, height) {
        return ("<iframe src=\"" + src + "\" width=\"" + width + "\" height=\"" + height + "\" style=\"max-width: 100%; box-sizing: border-box;\" pwc-video pwc-responsive></iframe>");
    }
...
function plugin$3(UIkit) {
    ...
    UIkit.component('notification', {
        ...
        defaults: {
            ...
            pos: 'top-center',
            onClose: null,
            clsClose: 'pwc-notification-close',
            clsMsg: 'pwc-notification-message'
        },

        created: function created() {

            if (!containers[this.pos]) {
                containers[this.pos] = $$$1(("<div class=\"pwc-notification pwc-notification-" + (this.pos) + "\"></div>")).appendTo(UIkit.container);
            }

            this.$mount($$$1(
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href=\"#\" class=\"" + (this.clsClose) + "\" data-pwc-close></a> <div>" + (this.message) + "</div> </div>")
...
function plugin$4(UIkit) {
    ...
    UIkit.component('sortable', {
        ...
        defaults: {
            ...
            animation: 150,
            threshold: 5,
            clsItem: 'pwc-sortable-item',
            clsPlaceholder: 'pwc-sortable-placeholder',
            clsDrag: 'pwc-sortable-drag',
            clsDragState: 'pwc-drag',
            clsBase: 'pwc-sortable',
            clsNoDrag: 'pwc-sortable-nodrag',
            clsEmpty: 'pwc-sortable-empty',
            clsCustom: '',
            handle: false
        },
...
function plugin$5(UIkit) {
    ...
    UIkit.component('tooltip', {
        ...
        defaults: {
            ...
            title: '',
            delay: 0,
            animation: ['pwc-animation-scale-up'],
            duration: 100,
            cls: 'pwc-active',
            clsPos: 'pwc-tooltip',
            container: true,
